const selectbtn = document.querySelectorAll("input[name=value-bottoms]");
const reset = document.querySelector(".output-values--reset");
const bill = document.getElementById("bill--input");
const people = document.getElementById("number-of-people--input");
